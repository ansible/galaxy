...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RoleRating.comment'
        db.alter_column(u'main_rolerating', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'RoleRating.comment'
        db.alter_column(u'main_rolerating', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
