...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.original_name'
        db.add_column(u'main_category', 'original_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'RoleVersion.original_name'
        db.add_column(u'main_roleversion', 'original_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'Platform.original_name'
        db.add_column(u'main_platform', 'original_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'Role.original_name'
        db.add_column(u'main_role', 'original_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.original_name'
        db.delete_column(u'main_category', 'original_name')

        # Deleting field 'RoleVersion.original_name'
        db.delete_column(u'main_roleversion', 'original_name')

        # Deleting field 'Platform.original_name'
        db.delete_column(u'main_platform', 'original_name')

        # Deleting field 'Role.original_name'
        db.delete_column(u'main_role', 'original_name')
