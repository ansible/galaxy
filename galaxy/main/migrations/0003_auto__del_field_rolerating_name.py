...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RoleRating.name'
        db.delete_column(u'main_rolerating', 'name')


    def backwards(self, orm):
        # Adding field 'RoleRating.name'
        db.add_column(u'main_rolerating', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, unique=True, db_index=True),
                      keep_default=False)
