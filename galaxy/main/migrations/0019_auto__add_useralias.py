...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserAlias'
        db.create_table(u'main_useralias', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alias_of', self.gf('django.db.models.fields.related.ForeignKey')(related_name='aliases', to=orm['accounts.CustomUser'])),
            ('alias_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
        ))
        db.send_create_signal(u'main', ['UserAlias'])


    def backwards(self, orm):
        # Deleting model 'UserAlias'
        db.delete_table(u'main_useralias')
    ...
    models = {
        ...
        u'main.useralias': {
            'Meta': {'object_name': 'UserAlias'},
            'alias_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
            'alias_of': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'aliases'", 'to': u"orm['accounts.CustomUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
