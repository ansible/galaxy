...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Role.date_added'
        db.delete_column(u'main_role', 'date_added')


    def backwards(self, orm):
        # Adding field 'Role.date_added'
        db.add_column(u'main_role', 'date_added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default='', blank=True, db_index=True),
                      keep_default=False)
