...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RoleRating.user'
        db.delete_column(u'main_rolerating', 'user_id')

        # Adding field 'RoleRating.owner'
        db.add_column(u'main_rolerating', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='ratings', to=orm['accounts.CustomUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RoleRating.user'
        db.add_column(u'main_rolerating', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='ratings', to=orm['accounts.CustomUser']),
                      keep_default=False)

        # Deleting field 'RoleRating.owner'
        db.delete_column(u'main_rolerating', 'owner_id')
