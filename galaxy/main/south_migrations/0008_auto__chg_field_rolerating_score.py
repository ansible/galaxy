...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RoleRating.score'
        db.alter_column(u'main_rolerating', 'score', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'RoleRating.score'
        db.alter_column(u'main_rolerating', 'score', self.gf('django.db.models.fields.IntegerField')())
