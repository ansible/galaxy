...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoleImport.state'
        db.add_column(u'main_roleimport', 'state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'RoleImport.status_message'
        db.add_column(u'main_roleimport', 'status_message',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoleImport.state'
        db.delete_column(u'main_roleimport', 'state')

        # Deleting field 'RoleImport.status_message'
        db.delete_column(u'main_roleimport', 'status_message')
