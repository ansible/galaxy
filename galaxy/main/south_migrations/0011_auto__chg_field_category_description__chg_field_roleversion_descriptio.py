...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_category', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'RoleVersion.description'
        db.alter_column(u'main_roleversion', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'RoleRating.description'
        db.alter_column(u'main_rolerating', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'RoleImport.description'
        db.alter_column(u'main_roleimport', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Platform.description'
        db.alter_column(u'main_platform', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding field 'Role.readme'
        db.add_column(u'main_role', 'readme',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Role.description'
        db.alter_column(u'main_role', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Category.description'
        db.alter_column(u'main_category', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'RoleVersion.description'
        db.alter_column(u'main_roleversion', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'RoleRating.description'
        db.alter_column(u'main_rolerating', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'RoleImport.description'
        db.alter_column(u'main_roleimport', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Platform.description'
        db.alter_column(u'main_platform', 'description', self.gf('django.db.models.fields.TextField')())
        # Deleting field 'Role.readme'
        db.delete_column(u'main_role', 'readme')


        # Changing field 'Role.description'
        db.alter_column(u'main_role', 'description', self.gf('django.db.models.fields.TextField')())
