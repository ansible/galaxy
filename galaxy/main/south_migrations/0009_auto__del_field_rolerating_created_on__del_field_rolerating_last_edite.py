...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RoleRating.created_on'
        db.delete_column(u'main_rolerating', 'created_on')

        # Deleting field 'RoleRating.last_edited'
        db.delete_column(u'main_rolerating', 'last_edited')


    def backwards(self, orm):
        # Adding field 'RoleRating.created_on'
        db.add_column(u'main_rolerating', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 3, 0, 0), blank=True, db_index=True),
                      keep_default=False)

        # Adding field 'RoleRating.last_edited'
        db.add_column(u'main_rolerating', 'last_edited',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2013, 12, 3, 0, 0), blank=True, db_index=True),
                      keep_default=False)
