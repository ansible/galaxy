...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field platforms on 'Role'
        m2m_table_name = db.shorten_name(u'main_role_platforms')
        ...
        db.create_unique(m2m_table_name, ['role_id', 'platform_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field platforms on 'Role'
        db.delete_table(db.shorten_name(u'main_role_platforms'))
