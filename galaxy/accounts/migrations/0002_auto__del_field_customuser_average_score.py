...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CustomUser.average_score'
        db.delete_column(u'accounts_customuser', 'average_score')


    def backwards(self, orm):
        # Adding field 'CustomUser.average_score'
        db.add_column(u'accounts_customuser', 'average_score',
